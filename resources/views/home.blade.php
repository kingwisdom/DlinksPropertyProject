                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex h-100">
                                        <div class="flex-shrink-0">
                                            <img class="img-fluid" src="assets/img/Delink cleared1.jpg" alt=""
                                        ...
                                        <div
                                            ...
                                            <a data-bs-toggle="modal" data-bs-target="#bookModal"
                                                class="btn btn-secondary">Book Inspection</a>
                                        </div>
                                    </div>
                                </div>
                                @auth
                                    ...
                                    <div class="modal fade" id="bookModal" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content rounded-0">
                                                ...
                                                <div class="modal-body">
                                                    <h3>Please confirm to book <b>{{ $item->name }}</b>?</h3>
                                                    <form method="post" action="{{ route('create_inpec') }}">
                        ...
                        <div class="row g-3">
                            @foreach ($complete as $item)
                                <div class="col-lg-6">
                                    <div class="d-flex h-100">
                                        <div class="flex-shrink-0">
                                            <img class="img-fluid" src="assets/img/Home 3.jpg" alt=""
                                                style="width: 150px; height: 85px;">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        ...
                        <p>We have plots of land scattered around our estates across Lagos, Ogun and Oyo State. The plots of
                            land are affordable and free from government acquisition.</p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        ...
                        <p>We sell Carcass building. Carcass building is completed but unfurnished. In this type of house,
                            the buyer have the liberty to decide how the interior will look like. </p>
                        <a class="text-uppercase text-dark" href="">Read More <i
                                class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        ...
                        <p>We have 1-bedroom, 2-Bedroom and 3-Bedroom Bungalows scattered in our Estates across Lagos, Ogun
                            and Ibadan State.</p>
                        <a class="text-uppercase text-dark" href="">Read More <i
                                class="bi bi-arrow-right"></i></a>
                    </div>
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    <h1 class="text-uppercase text-light mb-4">New Year Promo 30% Discount</h1>
                    <h4 class="text-light mb-4">You will get 30% discount on all the land and 20% on any of our houses.
                    </h4>
                    <h5 class="text-light mb-4">Promo span between Sept 15 and Dec. 31<br> (Note: term and condition apply)
                    </h5>
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item bg-dark text-white border-inner p-4">
                    <div class="d-flex align-items-center mb-3">
                        <img class="img-fluid flex-shrink-0" src="assets/img/Delinks Testimonial 3.jpg"
                            style="width: 60px; height: 60px;">
                        <div class="ps-3">
                    ...
                    <p class="mb-0">When it come to real estate here in Lagos, De-Links Property limited is in it own
                        class.
                    </p>
                </div>
                <div class="testimonial-item bg-dark text-white border-inner p-4">
                    <div class="d-flex align-items-center mb-3">
                        <img class="img-fluid flex-shrink-0" src="assets/img/Delinks Testimonial.jpg"
                            style="width: 60px; height: 60px;">
                        <div class="ps-3">
                    ...
                    <p class="mb-0">I bought a house from De-Links Property limited and the the keys were released
                        immediately I completed the payment. This is Waoh!
                    </p>
                </div>
                <div class="testimonial-item bg-dark text-white border-inner p-4">
                    <div class="d-flex align-items-center mb-3">
                        <img class="img-fluid flex-shrink-0" src="assets/img/Delinks Testimonial2.jpg"
                            style="width: 60px; height: 60px;">
                        <div class="ps-3">
                    ...
                    <p class="mb-0">It is a great pleasure buying from De-Links Property. They were transparent and
                        straightforward. I can recommend them.
                    </p>
                </div>
                <div class="testimonial-item bg-dark text-white border-inner p-4">
                    <div class="d-flex align-items-center mb-3">
                        <img class="img-fluid flex-shrink-0" src="img/Delinks Testimonial 4.jpg"
                            style="width: 60px; height: 60px;">
                        <div class="ps-3">
